...
const TicketPaymentModal = ({ show, setShow, data }) => {
    ...
    <div className={`fixed pt-40 top-0 left-0 right-0 bottom-0 bg-blue-100 bg-opacity-50 ${!show ? 'hidden' : ''}`}>
      <div className="w-2/5 bg-white shadow-2xl mx-auto rounded-lg ">
        <div className="flex justify-between pr-5">
          <h3 className="text-3xl font-semibold p-5 text-yellow-600">TidoPay</h3>
        ...
        {data == null ? <div className="p-2 flex justify-center">
          <h4 className="font-bold">40 TDO</h4>
        </div> : <div className="p-2 flex flex-column justify-center">
                <h4 className="font-bold">${data.price} ~ {data.price / 10} TDO</h4>
            </div>}
